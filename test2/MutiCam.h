...
private:
	...
	std::vector<OpenCVRecorderPtr> m_pVideoRecorders;
    // The Qt GUI
    Ui::MutiCamClass ui;
	...
	// A list of selected camera IDs
	std::vector<std::string> m_selected_cameras;
    // Are we streaming?
    bool m_bIsStreaming;
...
private slots:
	...
	void AcquisitionLoop(); // useless

 signals:
	void StartActionCommandSignal(); // useless
};
